...
from pycocotools.coco import COCO # COCO API，用于加载/处理 COCO 格式
from pycocotools.cocoeval import COCOeval # COCO 评估器，算 AP

from maskrcnn_benchmark.data import get_dataset_statistics # 获取数据集统计信息
from maskrcnn_benchmark.structures.bounding_box import BoxList
from maskrcnn_benchmark.structures.boxlist_ops import boxlist_iou # 计算两个 BoxList 之间的 IoU 矩阵
from maskrcnn_benchmark.utils.miscellaneous import intersect_2d, argsort_desc, bbox_overlaps
from maskrcnn_benchmark.data.datasets.evaluation.vg.sgg_eval import SGRecall, SGNoGraphConstraintRecall, SGPairAccuracy, SGMeanRecall, SGNGMeanRecall, SGAccumulateRecall
...
def do_vg_evaluation(
    ...
    if "bbox" in iou_types:
        ...
        if len(cocolike_predictions) == 0:
            print("[Warning] No predictions generated. Skipping evaluation.")
            return {}
