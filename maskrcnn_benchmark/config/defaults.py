...
_C.MODEL.PROGRESSIVE_UNFREEZE = False
_C.MODEL.UNFREEZE_SCHEDULE = [[5, ["layer4"]], [10, ["layer3"]]]
...
_C.MODEL.RELATION.FREEZE_FEATURE_EXTRACTOR = False

# 注册 LOSS_WEIGHT 配置块
_C.MODEL.ROI_RELATION_HEAD.LOSS_WEIGHT = CN()
_C.MODEL.ROI_RELATION_HEAD.LOSS_WEIGHT.RELATION_LOSS_WEIGHT = [1.0, 1.0, 1.0]
